...
\end{center}
    ...
    \begin{center}
        ...
        \end{center}
        \centering
            \includegraphics[width=1\linewidth]{./data/solutions.png}
...
\begin{figure}[!h]
    ...
    \end{center}
    \centering
        \includegraphics[width=1\linewidth]{./data/total.png}
...
\begin{figure}[!h]
    ...
    \end{center}
    \centering
        \includegraphics[width=1\linewidth]{./data/lte.png}
...
\begin{figure}[!h]
    ...
    \end{center}
    \centering
        \includegraphics[width=1\linewidth]{./data/gte.png}
...
\subsubsection*{Solutions}
        \resizebox{\textwidth}{!}{%
    \csvautotabular{./data/dataframe.csv}
    %
    }
\end{center}
...
\subsubsection*{Local and global truncation errors}
        ...
        \resizebox{\textwidth}{!}{%
    \csvautotabular{./data/dataframe-errors.csv}
    %
    }
\end{center}
...
\subsubsection*{Total errors}
        ...
        \resizebox{\textwidth}{!}{%
    \csvautotabular{./data/total-errors.csv}
    %
    }
\end{center}
...
\begin{figure}[!h]
    ...
    \end{center}
    \centering
        \includegraphics[width=1\linewidth]{./data/uml.png}
...
\begin{figure}[!h]
    ...
    \end{center}
    \centering
        \includegraphics[width=1\linewidth]{./data/callback.png}
    % \caption{Unified Modeling Language diagram}
\end{figure}
